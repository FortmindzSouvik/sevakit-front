...
export default function AllergyDeleteModal({
  isOpen,
  onClose,
  onSuccess,
  allergyId,
  ...
  const { mutateAsync: deleteAllergies, isPending } = useDeleteData([
    "delete-allergies",
  ]);

  const handleDelete = async () => {
    try {
      await deleteAllergies(`${apiRoutes.updateAllergy(allergyId)}`);
      ...
      <DialogContent className="max-w-md p-9 rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-[#000000] text-base leading-relaxed font-mona">
            This allergy will be removed from your health profile.
          </p>
