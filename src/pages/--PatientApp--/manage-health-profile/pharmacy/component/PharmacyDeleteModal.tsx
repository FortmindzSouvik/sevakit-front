...
export default function PharmacyDeleteModal({
  isOpen,
  onClose,
  onSuccess,
  pharmacyId,
  ...
  const handleDelete = async () => {
    try {
      await deletePharmacy(`${apiRoutes.updatePharmacy(pharmacyId)}`);
      toast.success("Pharmacy details deleted successfully.");
    } catch (error) {
      ...
      <DialogContent className="max-w-md p-9 rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-[#000000] text-base leading-relaxed font-mona">
            This will remove your pharmacy details from your health profile.
          </p>
