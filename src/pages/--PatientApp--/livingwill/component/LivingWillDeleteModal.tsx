...
export default function LivingWillDeleteModal({
  isOpen,
  onClose,
  onSuccess,
  livingWillId,
  ...
  const handleDelete = async () => {
    try {
      await deleteSymptoms(`${apiRoutes.updateLivingWill(livingWillId)}`);
      ...
      <DialogContent className="max-w-md p-9 rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-[#000000] text-base leading-relaxed font-mona">
            This will remove your Living Will summary and all attached
            documents.{" "}
          </p>
