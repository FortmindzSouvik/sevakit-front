...
const AccountAlreadySetUpModalForProvider = ({
  isOpen,
  onClose,
  phoneNumber,
}: {
      ...
      >
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-[#000000] text-base leading-relaxed font-mona">
            An existing account with this Phone Number already exists.
          ...
          <DialogFooter className="w-fit flex items-center justify-center gap-6 pt-2 ">
            <button
              ...
              onClick={() => {
                (navigate(`/${ROUTES.auth.resetPasswordMsgForProvider}`, {
                  state: {
                    phoneNumber,
                  },
                }),
...
export default AccountAlreadySetUpModalForProvider;
