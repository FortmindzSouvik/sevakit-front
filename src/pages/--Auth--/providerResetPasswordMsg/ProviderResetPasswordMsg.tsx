import { useProviderRequestNewPasswordLink } from "@/hooks/useUserAuth";
import { ROUTES } from "@/utils/routeConstants";
import { useState } from "react";
import { useLocation, useNavigate } from "react-router";
import CheckPhoneNumberForProviderModal from "../createProviderAccount/component/CheckPhoneNumberForProviderModal";

export interface PhoneVerifyPayload {
  phoneNumber: string;
}

const ProviderResetPasswordMsg = () => {
  ...
  const { mutateAsync: requestnewPasswordLinkForProvider } =
    useProviderRequestNewPasswordLink();
  ...
  const handleContinueClick = async () => {
    ...
    try {
      const resp = await requestnewPasswordLinkForProvider(payload);
  ...
  return (
    <div className="container max-w-md mx-auto px-4 py-12">
      ...
      <CheckPhoneNumberForProviderModal
        isOpen={existsModal}
...
export default ProviderResetPasswordMsg;
